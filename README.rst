...
-------------------------------
*OpenWISP Notifications* allows users to even notification preferences based on target object.
...
``OPENWISP_NOTIFICATIONS_OBJECT_NOTIFICATION_WIDGET``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
You will require to add dotted path to desired model admins.
...
.. code-block:: python
    ...
    OPENWISP_NOTIFICATIONS_OBJECT_NOTIFICATION_WIDGET = ['openwisp_users.admin.UserAdmin']
...
.. code-block:: text
    ...
    POST /api/v1/notification/ignore/{app_label}/{model_name}/{object_id}/
